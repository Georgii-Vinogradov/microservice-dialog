...
class KafkaConsumerServiceTest {
    ...
    public void testReceiveMessage() {
        ...
        assertDoesNotThrow(() -> kafkaConsumerService
                .receiveMessage(streamingMessageDto, 123456789L, mock(Acknowledgment.class)));

        verify(dialogService, times(1)).createMessage(messageCaptor.capture());

        MessageDto result = messageCaptor.getValue();
